...
class Vector {
    ...
    opfn self[index as U8] as Float {
        self.values[index]
    };

    // standard function
    sfn iter(self) as Iterator[Float] {
        self.values.iter()
    };
    ...
    */
    fn operation(self, other as Vector, op_func as Function) {
        new_values as List[Float] = [];
